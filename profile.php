...
if (confirm("Are u sure to logout?!") == true) {
  ...
  <div id="">
    <div id="navbar">
      <h1><i>Profile</i></h1>
      <button type="button" class="btn btn-danger" onclick="myFunction()" style="margin-left:93%;margin-top: -6%;">Logout</button>
      <!-- <button class="btn btn-danger" onclick="myFunction()" style="margin-left:93%;margin-top: -6%;">Logout</button> -->
    </div>
    <div class="profile-card" align="center" >
      <div class="col-md-8" id="Login_form">
        <div class="card mb-8">
           <div class="card-body" style="box-shadow: 40px 40px 40px rgba(0, 0, 0, 0.2);">
            
              <div class="row">
                <center><h4><b>Welcome <?php echo $USERNAME ?>😍</b></h4></center>
              </div>
              <hr>
              <div class="row">
                <div class="col-sm-3">
      ...
      <div class="col-md-8" id="hiddenForm" hidden>
        ...
        <div class="card-body">
              ...
              <!-- edit button -->
                <div class="row">
                <div class="col-sm-12">
                  <a class="btn btn-info " id="showLogLinks" href="#" onclick="Update()">Update</a>
...
<script>
    ...
    function Update(){
        ...
        localStorage.setItem('x',file.name);
        var storedImageURL =localStorage.getItem('x');
    ...
    showLogLinks.addEventListener("click", function (event) {
        event.preventDefault(); // Prevent the default link behavior
        Login_form.style.display="block";
        hiddenForm.toggleAttribute("hidden");
        location.reload();
